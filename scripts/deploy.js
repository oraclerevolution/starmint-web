...
async function main() {
  ...
  const starmintEth = await StarmintEth.deploy();

  await starmintEth.deployed();

  console.log(`Le contract a été deployé sur Polygon à l'adresse ${starmint.address}`);
  console.log(`Le contract a été deployé sur Ethereum à l'adresse ${starmintEth.address}`);
}
